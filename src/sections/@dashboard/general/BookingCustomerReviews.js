...
export default function BookingCustomerReviews() {
  ...
  return (
    <Card>
      ...
      <ReviewItem key={230} item={"Hello", "World", "My Name", "", 3, ["Hello", "My Name"]} />
    </Card>
  );
}
  ...
  return (
    <Stack spacing={2} sx={{ minHeight: 402, position: 'relative', p: 3 }}>
      ...
      <Stack direction="row" spacing={2} alignItems="flex-end" sx={{ flexGrow: 1 }}>
        <Button fullWidth variant="contained" color="success"  endIcon={<Iconify icon={'eva:checkmark-circle-2-fill'} />}>
          Accept
        </Button>
